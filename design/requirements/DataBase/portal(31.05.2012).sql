...
# Dumping structure for table portal.links
DROP TABLE IF EXISTS `links`;
CREATE TABLE IF NOT EXISTS `links` (
  `id_link` int(11) NOT NULL AUTO_INCREMENT,
  `link_name` varchar(300) DEFAULT NULL,
  `id_project` int(11) NOT NULL,
  PRIMARY KEY (`id_link`),
  KEY `links_pr_fk` (`id_project`),
  CONSTRAINT `links_pr_fk` FOREIGN KEY (`id_project`) REFERENCES `projects` (`id_project`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

# Dumping data for table portal.links: ~7 rows (approximately)
DELETE FROM `links`;
...
# Dumping data for table portal.l_pos: ~0 rows (approximately)
DELETE FROM `l_pos`;
...
# Dumping data for table portal.l_technologies_pr: ~14 rows (approximately)
...
INSERT INTO `message` (`id_message`, `title`, `text`, `data_m`, `id_user_from`, `id_previous_message`, `is_readed`, `priority`) VALUES
	(1, 'Hello!', 'We are greating you on our web-site)', '2011-05-28', 2, NULL, 1, 1),
	(2, 'Hello!', 'Let\'s go to bar. I found a new client. He want to meet us and discusse work.', '2011-05-28', 3, NULL, 0, 2),
...
# Dumping data for table portal.projects: ~32 rows (approximately)
...
# Dumping structure for table portal.project_status
...
# Dumping data for table portal.project_status: ~2 rows (approximately)
DELETE FROM `project_status`;
/*!40000 ALTER TABLE `project_status` DISABLE KEYS */;
INSERT INTO `project_status` (`id_status`, `status_name`) VALUES
	(1, 'existing'),
	(2, 'deleted');
