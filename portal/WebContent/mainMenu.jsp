...
<ul>
	...
	<c:choose>
		<c:when test='${currentPage=="Main"}'>
			<li><a href="/portal/index.jsp" style="color: Red">Main</a></li>
		</c:when>
		<c:otherwise>
	...
	<c:choose>
		<c:when test='${currentPage=="Projects"}'>
			<li><a href="/portal/Servlet/ShowProjects" style="color: Red">Projects</a></li>
		</c:when>
		<c:otherwise>
	...
	<c:choose>
		<c:when test='${currentPage=="News"}'>
			<li><a href="/portal/Servlet/ShowNews" style="color: Red">News</a></li>
		</c:when>
		<c:otherwise>
	...
	<c:choose>
		<c:when test='${currentPage=="Users"}'>
			<li><a href="/portal/Servlet/ShowUserProf" style="color: Red">Users</a></li>
		</c:when>
		<c:otherwise>
	...
	<c:choose>
		<c:when test='${currentPage=="CV/Job"}'>
			<li><a href="#" style="color: Red">CV/Job</a></li>
		</c:when>
		<c:otherwise>
